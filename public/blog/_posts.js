  ...
  const POSTS = [
    {
      ...
      date: '2026. 8. 1',
      category: '시리즈 · 질문의 시대는 끝났다 · 4편',
      href: '/blog/prompt-to-agent-4.html',
      author: '신성진',
      publishTime: '10:30:00',
      dek: '한 공무원이 자기 골목길을 치웠더니, 중앙부처가 같은 방식으로 국가 데이터를 열었다. 코닥·국가법령정보 MCP에서 KOSIS MCP까지 — 그리고 모든 AI 도입 안건 앞에 붙여야 할 Cheaper·Better·Faster·Easier 네 개의 질문. 특강 시리즈 완결편.',
      views: { base: 10, daily: 8, publishedISO: '2026-08-01' },
    },
    {
      slug: 'prompt-to-agent-3',
      title: '질문의 시대는 끝났다 ③ 중간관리자, AX팀, 그리고 튀는 사람',
      date: '2026. 8. 1',
      category: '시리즈 · 질문의 시대는 끝났다 · 3편',
      href: '/blog/prompt-to-agent-3.html',
      author: '신성진',
      publishTime: '10:00:00',
      dek: '중간관리자는 컨텍스트를 만드는 사람이다. AX팀의 최소 조합은 업무·도구·조직을 아는 세 사람이다. AI를 잘 쓰는 사람은 뽑는 것이 아니라 교육으로 발굴하는 것이다 — 기관 전환에서 사람의 자리를 다루는 3편.',
      views: { base: 10, daily: 8, publishedISO: '2026-08-01' },
    },
    {
      slug: 'prompt-to-agent-2',
      title: '질문의 시대는 끝났다 ② RAG 구축의 시대를 지나, 에이전트를 향해',
      date: '2026. 8. 1',
      category: '시리즈 · 질문의 시대는 끝났다 · 2편',
      href: '/blog/prompt-to-agent-2.html',
      author: '신성진',
      publishTime: '09:30:00',
      dek: '청크 RAG, 문서 통째 읽기, 에이전틱 검색, MCP 직접 연결 — 문서를 쪼개는 방식 자체를 다시 물어야 한다. 발주서에 무엇을 만들지보다 누가 함께 만들지를 먼저 쓰는 AI 사업, 그리고 기술보다 업무와 사람을 먼저 보는 리더의 순서.',
      views: { base: 10, daily: 8, publishedISO: '2026-08-01' },
    },
    {
      slug: 'prompt-to-agent-1',
      title: '질문의 시대는 끝났다 ① 기술은 네 번 이동했다 — 프롬프트 · 컨텍스트 · 하네스 · 피지컬 AI',
      date: '2026. 8. 1',
      category: '시리즈 · 질문의 시대는 끝났다 · 1편',
      href: '/blog/prompt-to-agent-1.html',
      author: '신성진',
      publishTime: '09:00:00',
      dek: '빅3가 같은 달에 내놓은 것은 챗봇이 아니라 에이전트였다. 프롬프트 → 컨텍스트 → 하네스 → 피지컬 AI, 지난 3년 AI 활용의 중심이 네 번 이동한 궤적을 공공기관 관리자·실무자의 눈높이로 정리한 특강 시리즈 1편.',
      views: { base: 10, daily: 8, publishedISO: '2026-08-01' },
    },
    {
