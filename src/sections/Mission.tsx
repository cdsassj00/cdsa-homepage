      ...
      <div className="container-editorial">
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-8">
            <h2 className="h-display text-[32px] md:text-[52px] whitespace-pre-line">
              {mission.heading}
            </h2>
            <div className="mt-10 space-y-6 text-[17px] md:text-lg text-ink-700 leading-[1.85] max-w-2xl font-serif">
              {mission.body.split('\n\n').map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
            <figure className="mt-12 pl-6 border-l-2 border-clay-500">
